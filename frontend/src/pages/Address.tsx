...
try {
const { data } = await
axios.get(`${restserviceurl}/api/address/all`, {
headers: {
...
setAdding(true);
await axios.post(
`${restserviceurl}/api/address/add`,
{
formattedAddress,
mobile,
latitude,
...
try {
setDeletingId(id);
await axios.delete(`${restserviceurl}/api/address/delete/${id}`, {
headers: {
Authorization: `Bearer ${localStorage.getItem("token")}`,
},
});
...
>
<TileLayer
url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"attribution='&copy; <a
